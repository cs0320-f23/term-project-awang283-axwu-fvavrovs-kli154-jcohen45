...
public class Tags {
    ...
    public Tags() {
      this.jumboTags = new HashMap<>();
        ...
        jumboTags.put("free food", new ArrayList<>(Arrays.asList("food", "pizza", "kabob", "snack", "boba", "lunch",
        ...
        jumboTags.put("stem", new ArrayList<>(Arrays.asList("stem", "scien", "engin", "tech", "math", "biology", "chem", "physics")));
        ...
        jumboTags.put("POC", new ArrayList<>(Arrays.asList("poc", "black", "asian", "hispanic", "latin", "aapi", "indigenous",
                "native american", "bcsc", "of color")));
        ...
        jumboTags.put("religious", new ArrayList<>(Arrays.asList("religi", "christian", "jew", "muslim", "worship", "prayer")));
    ...
    public ArrayList<String> getTags() {
        ArrayList tags = new ArrayList<String>(Arrays.asList("alcohol", "subfree", "dance", "performance", "a capella",
                ...
                "prelaw", "women", "rsvp required", "dug", "languages"));
        return tags;
    }
